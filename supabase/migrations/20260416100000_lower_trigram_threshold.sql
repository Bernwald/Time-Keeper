-- Lower the pg_trgm word_similarity threshold from 0.4 to 0.3 across all
-- hybrid retrieval functions so morphological variants like "Pilotkontakte"
-- vs. "Pilot Kunden" can enter the trigram arm of the RRF pool. The vector
